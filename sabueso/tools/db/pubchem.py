...
def fetch_pubchem_json(cid: str) -> Dict[str, Any]:
    ...
    props = "MolecularWeight,MolecularFormula,XLogP,TPSA,HBondDonorCount,HBondAcceptorCount,RotatableBondCount,InChI,InChIKey,CanonicalSMILES,ConnectivitySMILES"
