# Tutorial: `create_ted_card_from_json`
...
2. Call `create_ted_card_from_json`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.ted import create_ted_card_from_json

payload = {}  # Replace with real TED payload
card = create_ted_card_from_json(payload, retrieved_at="2026-02-04")
