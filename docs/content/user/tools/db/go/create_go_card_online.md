# Tutorial: `create_go_card_online`

## Goal

Fetch GO data and create a Sabueso Card in one call.

## Steps

1. Choose a valid identifier or input payload.
2. Call `create_go_card_online`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.go import create_go_card_online

card = create_go_card_online("GO:0008150", retrieved_at="2026-02-04")
