# Tutorial: `create_go_card_from_file`
...
2. Call `create_go_card_from_file`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.go import create_go_card_from_file

card = create_go_card_from_file("path/to/go_sample.json", retrieved_at="2026-02-04")
