# Tutorial: `create_go_card_from_json`
...
2. Call `create_go_card_from_json`.
...
payload = {}  # Replace with real GO payload
card = create_go_card_from_json(payload, retrieved_at="2026-02-04")
