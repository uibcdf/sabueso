# Tutorial: `create_interpro_card_from_json`
...
2. Call `create_interpro_card_from_json`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.interpro import create_interpro_card_from_json

payload = {}  # Replace with real InterPro payload
card = create_interpro_card_from_json(payload, retrieved_at="2026-02-04")
