# Tutorial: `create_molecule_card_from_json`
...
2. Call `create_molecule_card_from_json`.
...
payload = {}  # Replace with real ChEMBL payload
card = create_molecule_card_from_json(payload, retrieved_at="2026-02-04")
