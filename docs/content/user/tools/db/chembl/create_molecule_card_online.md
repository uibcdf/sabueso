...
2. Call `create_molecule_card_online`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.chembl import create_molecule_card_online

card = create_molecule_card_online("CHEMBL90555", retrieved_at="2026-02-04")
