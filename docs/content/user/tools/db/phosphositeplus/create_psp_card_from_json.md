# Tutorial: `create_psp_card_from_json`
...
2. Call `create_psp_card_from_json`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.phosphositeplus import create_psp_card_from_json

payload = {}  # Replace with real PhosphoSitePlus payload
card = create_psp_card_from_json(payload, retrieved_at="2026-02-04")
