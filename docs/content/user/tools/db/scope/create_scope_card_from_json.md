# Tutorial: `create_scope_card_from_json`
...
2. Call `create_scope_card_from_json`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.scope import create_scope_card_from_json

payload = {}  # Replace with real SCOPe payload
card = create_scope_card_from_json(payload, retrieved_at="2026-02-04")
