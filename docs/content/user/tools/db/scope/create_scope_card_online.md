# Tutorial: `create_scope_card_online`

## Goal

Fetch SCOPe data and create a Sabueso Card in one call.

## Steps

1. Choose a valid identifier or input payload.
2. Call `create_scope_card_online`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.scope import create_scope_card_online

card = create_scope_card_online("d2nzta1", retrieved_at="2026-02-04")
