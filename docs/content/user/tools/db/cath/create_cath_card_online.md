# Tutorial: `create_cath_card_online`

## Goal

Fetch CATH data and create a Sabueso Card in one call.

## Steps

1. Choose a valid identifier or input payload.
2. Call `create_cath_card_online`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.cath import create_cath_card_online

card = create_cath_card_online("2nztA00", retrieved_at="2026-02-04")
