# Tutorial: `create_cath_card_from_json`
...
2. Call `create_cath_card_from_json`.
3. Validate canonical output fields.

## Example

```python
from sabueso.tools.db.cath import create_cath_card_from_json

payload = {}  # Replace with real CATH payload
card = create_cath_card_from_json(payload, retrieved_at="2026-02-04")
