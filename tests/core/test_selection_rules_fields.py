...
def test_domains_priority_sources_allow_multiple():
    assertions = [
        _sa({"id": "IPR0001", "name": "DomainA"}, "InterPro", "2026-02-01", "sa1"),
        _sa({"id": "IPR0002", "name": "DomainB"}, "InterPro", "2026-02-02", "sa2"),
        _sa({"id": "CATH1", "name": "DomainC"}, "CATH", "2026-02-03", "sa3"),
    ]
    rules = {
...
def test_molecular_weight_most_recent():
    assertions = [
        _sa(350.1, "PubChem", "2026-02-01", "sa1"),
        _sa(351.0, "ChEMBL", "2026-02-05", "sa2"),
    ]
    rules = {
        "field_rules": {
...
def test_smiles_priority_sources_single():
    assertions = [
        _sa("C1CC", "PubChem", "2026-02-01", "sa1"),
        _sa("C1CCC", "ChEMBL", "2026-02-02", "sa2"),
    ]
    rules = {
